...
if($sql2['data_termino'] > time()) { ?>
<center><div class="top-counter">
	<div id="icon"><i class="icon-clock"></i></div>
	<div id="infos"><b class="top-counter-time"><?=$sql2['data_termino'];?></b> para o fim da votação</div>
	<br>
</div></center>
...
<? } else {
	echo '<center>A votação para essa semana já encerrou. Você pode conferir o resultado ao lado.</center>';
} ?>
</div>